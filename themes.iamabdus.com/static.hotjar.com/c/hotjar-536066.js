window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["settings.billing_v2", "survey.type_button", "survey.image_question", "sessionizer_beta_enabled", "ask.use_insights_internal_api", "feedback.widgetV2", "survey.embeddable_widget", "heatmap.continuous.manual_retaker", "client_script.compression.pc", "feedback.embeddable_widget", "error_reporting", "feedback.widget_telemetry", "ask.separate_service"],
...
! function(e) {
    ...
    247: function(e, t, r) {
        ...
        window.hjBootstrap = window.hjBootstrap || function(e, t, r) {
            ...
            f.async = 1, f.src = hj.scriptDomain + t, f.charset = "utf-8", l.appendChild(f), u.revision = "0b59b5a", window.hjBootstrap = u
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.ee587d1590c42117acc4.js", "536066"), hj.metrics.timeEnd("resource-blocking-time", {
            tag: {
                resource: "hotjar-js"
            },
            start: j,
            ...
            SURVEY_V2: {
                js: "survey-v2.d14e626245b82b681ff7.js"
            },
            SURVEY_BOOTSTRAPPER: {
                js: "survey-bootstrapper.3c00a8da771773527325.js"
            },
            SURVEY_ISOLATED: {
                js: "survey-isolated.37fa8e539a0a8a3429b9.js"
            },
            HEATMAP_RETAKER: {
                js: "heatmap-retaker.8d255a4527c25356df15.js"
            },
            SURVEY_INVITATION: {
                js: "survey-invitation.bb14f24d86df448d3167.js"
            },
            NOTIFICATION: {
                js: "notification.d985fbeaf43df0df67a1.js"
            },
            INCOMING_FEEDBACK: {
                js: "incoming-feedback.41dff3c93e5760605102.js"
            },
            PREACT_INCOMING_FEEDBACK: {
                js: "preact-incoming-feedback.d311fbd03b1a0a6885be.js"
            },
            SENTRY: {
                js: "sentry.b1b008a2568ec4416300.js"
            },
            BROWSER_PERF: {
                js: "browser-perf.1a952b8b21b64f8081f0.js"
            }
        }
    }
});