                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="p-6 d-lg-flex justify-content-between align-items-center ">
                                <div class="d-md-flex align-items-center">
                                    <img src="{{ asset('admin/images/avatar/avatar-3.jpg') }}" alt="Image"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="border-top-0 "> <img
                                                    src="{{ asset('admin/images/svg/browser-svg/chrome.svg') }}"
                                        ...
                                        <tr>
                                            <td> <img src="{{ asset('admin/images/svg/browser-svg/firefox.svg') }}"
                                        ...
                                        <tr>
                                            <td> <img src="{{ asset('admin/images/svg/browser-svg/brave.svg') }}"
                                                    alt="Image" class="me-2"><span>Brave</span></td>
                                            <td class="text-end  ">14.43%</td>

                                        </tr>
                                        <tr>
                                            <td> <img src="{{ asset('admin/images/svg/browser-svg/safari.svg') }}"
                                        ...
                                        <tr>
                                            <td> <img src="{{ asset('admin/images/svg/browser-svg/ie.svg') }}"
                                        ...
                                        <tr>
                                            <td> <img src="{{ asset('admin/images/svg/browser-svg/opera.svg') }}"
                                        ...
                                        <tr>
                                            <td> <img src="{{ asset('admin/images/svg/browser-svg/microsoft-edge.svg') }}"
